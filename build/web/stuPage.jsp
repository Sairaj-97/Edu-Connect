...
<div class="centreAlign"> 
   ...
   <a href="giveFeed.jsp" class="homebuttons">Give Teacher Feedback</a>
   <a href="registerConcern.jsp" class="homebuttons">Register Concern</a>
   <a href="attemptQuiz.jsp" class="homebuttons">Attempt Quiz</a>
   <a href="stuViewScore.jsp" class="homebuttons">View Marks</a>
