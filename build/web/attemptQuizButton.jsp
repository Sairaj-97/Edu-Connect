 ...
 <nav>
  ...
  <div class="menu"> 
   <ul>
    ...
    <h1 style="line-height:140px;font-size: 40px;color:white;text-align: center;margin-top:80px; ">Quiz will begin once you click on the button below . best of luck :)</h1>
    <div class="ahover">
    <table style="border:3px solid black;border-collapse: collapse;margin-left: auto;margin-top: 20px;margin-right: auto;">
        <tr style="border:1px solid black;">
            ...
            <td style="border:1px solid black;background-color: white;font-size: 30px;padding: 5px;"><a style="text-decoration: none;" href="loadQuiz.jsp">Attempt now</a></td>
        </tr>
    </table>
    </div> 
    </div>
