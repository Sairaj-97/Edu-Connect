 ...
 <nav>
  ...
  <div class="menu"> 
   <ul>
    ...
    <li><a href="updatePasswordTchr.jsp">Update Password</a></li>
...
<br>     <br> <br>   
   ...
   <a href="updateStuRec1.jsp" class="homebuttons">update Student Record</a>
   <a href="messageParent.jsp" class="homebuttons">Message Parent</a>
   <a href="uploadQuiz.jsp" class="homebuttons">upload quiz</a>
